...
const Profile = ({openProfile, setOpenProfile, currentUser, getOrdersCount}) => {
  const [count, setCount] = useState();
  useEffect(() =>{
    const getOrderData = getOrdersCount();
    return async () => {
      const allData = await getOrderData;
      setCount(allData);
    };
  },[]);
